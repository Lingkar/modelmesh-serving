...
docker buildx build --push --platform linux/amd64,linux/arm64 -f ${CONTEXT_DIR}/Dockerfile.develop -t ${IMAGE_NAME}:latest ${CONTEXT_DIR}

echo -n "${IMAGE_NAME}:latest" > .develop_image_name
